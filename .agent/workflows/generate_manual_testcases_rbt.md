...
1. Đọc prompt template: `plans/01_context_and_roleplay/prompt.txt`
...
1. Đọc prompt template: `plans/02_analysis_and_qna/prompt.txt`
...
1. Đọc prompt template: `plans/03_decomposition/prompt.txt`
...
1. Đọc prompt template: `plans/04_traceability/prompt.txt`
